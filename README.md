...
DONE: Bee: keeping the current x-axis zoom seems good, but i guess i sort of expected the y-axis zoom to update. 

DONE: Dreev: let's call the zoom-out button good enough for now. bee hadn't noticed that initially. 
